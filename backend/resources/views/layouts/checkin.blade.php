...
<head>
    ...
    <link rel="icon" type="image/png" href="@yield('property_favicon', asset('images/logo_hospedacheck.png'))">
...
<body class="bg-gray-100 min-h-screen">
    <div class="max-w-2xl mx-auto px-4 py-8">
        <div class="text-center mb-6">
            <img src="@yield('property_logo', asset('images/logo_hospedacheck.png'))" alt="@yield('property_name', config('app.name'))" class="h-12 mx-auto mb-2" style="max-width: 200px;">
            <h1 class="text-2xl font-bold text-gray-900">@yield('property_name', config('app.name'))</h1>
            <p class="text-gray-500 mt-1">@yield('property_subtitle', 'HospedaCheck, gestión de visitantes')</p>
        </div>
        @yield('content')
    </div>
    @stack('scripts')
