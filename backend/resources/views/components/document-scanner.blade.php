    ...
    <template x-teleport="body">
        ...
        >
            ...
            <div class="flex-1 relative flex items-center justify-center min-h-0 bg-black">
                ...
                <div class="absolute left-[5%] right-[5%] bottom-[10%] h-[30%]
                            border-2 border-dashed border-yellow-400 rounded-lg
                            bg-yellow-400/5 pointer-events-none flex items-center justify-center">
                    <span class="text-yellow-300 text-xs font-medium bg-black/60 px-2 py-1 rounded select-none">
                        Encuadre la zona de caracteres aqu&iacute;
                    </span>
                </div>
