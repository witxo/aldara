<?php $__env->startSection('title', 'Check-in Online'); ?>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($error)): ?>
    <div class="bg-white rounded-lg shadow p-8 text-center">
        ...
        <p class="text-gray-500"><?php echo e($error); ?></p>
    </div>
<?php elseif(isset($completed)): ?>
    <div class="bg-white rounded-lg shadow p-8 text-center">
        ...
        <p class="text-gray-400 text-sm mt-4">Código de reserva: <?php echo e($reservation->code); ?></p>
    </div>
<?php else: ?>
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="bg-gray-50 rounded-lg p-4 mb-6">
            <div class="grid grid-cols-2 gap-3 text-sm">
                <div><span class="text-gray-500">Código:</span> <span class="font-medium"><?php echo e($reservation->code); ?></span></div>
                <div><span class="text-gray-500">Huésped:</span> <span class="font-medium"><?php echo e($reservation->guest_name); ?></span></div>
                <div><span class="text-gray-500">Entrada:</span> <span class="font-medium"><?php echo e($reservation->checkin_date->format('d/m/Y')); ?></span></div>
                <div><span class="text-gray-500">Salida:</span> <span class="font-medium"><?php echo e($reservation->checkout_date->format('d/m/Y')); ?></span></div>
                <div><span class="text-gray-500">Adultos:</span> <span class="font-medium"><?php echo e($reservation->adults); ?></span></div>
                <div><span class="text-gray-500">Menores:</span> <span class="font-medium"><?php echo e($reservation->children); ?></span></div>
            </div>
        </div>

        <form method="POST" action="<?php echo e(route('public.checkin.submit', $reservation->checkin_token)); ?>" class="space-y-6">
            <?php echo csrf_field(); ?>
            <div id="guests-container">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select name="guests[0][document_type]" required class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(config('checkin.require_signature')): ?>
            <div>
...
<script>
    let guestCount = 1;
    const maxGuests = <?php echo e(config('checkin.max_guests', 20)); ?>;
    const totalGuests = <?php echo e($reservation->adults + $reservation->children); ?>;
    ...
    <?php if(config('checkin.require_signature')): ?>
...
<?php echo $__env->make('layouts.checkin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/public/checkin.blade.php ENDPATH**/ ?>